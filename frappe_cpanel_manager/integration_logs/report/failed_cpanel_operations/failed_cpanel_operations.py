...
def execute(filters=None):
	...
	columns = [
		...
		{"label": _("Operation"), "fieldname": "operation", "fieldtype": "Data", "width": 190},
		{"label": _("Error Category"), "fieldname": "error_category", "fieldtype": "Data", "width": 160},
		{"label": _("Retries"), "fieldname": "retry_count", "fieldtype": "Int", "width": 80},
		{
			"label": _("Log"),
			"fieldname": "log",
			"fieldtype": "Link",
